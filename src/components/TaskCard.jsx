...
//       className="p-4 border task-card rounded-xl bg-gray-200 task-card shadow-md hover:shadow-lg transition-all flex flex-col gap-3"
//     >
//       {/* Task Content */}
//       <div>
...
//       <div className="flex flex-wrap md:flex-nowrap justify-between lg:p-4 items-center gap-3 border-t-blue-500  mt-4 pt-3 rounded-lg shadow-sm">
//         {/* Date Information */}
    ...
    >
      ...
      <div className="flex flex-wrap lg:flex-nowrap justify-between py-2 items-center gap-3 border-t-blue-500  mt-4 pt-3 rounded-lg shadow-sm">
        ...
        <div className="text-xs space-y-2">
          ...
          <p className={remainingTime ==="Deadline has passed"? ` px-2 py-1 w-fit rounded-lg bg-red-100 text-red-600 font-semibold text-sm`:` px-2 py-1 w-fit rounded-lg bg-blue-100 text-blue-600 font-semibold text-sm`}>
            {remainingTime}
          </p>
        </div>
